...
let Team = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('team')];
    ...
    var Team = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.employees = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _employees_initializers, void 0));
    ...
    (() => {
        ...
        _employees_decorators = [(0, typeorm_1.OneToMany)(() => employee_1.Employee, employee => employee.team)];
