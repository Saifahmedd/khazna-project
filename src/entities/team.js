...
var Team = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('team')];
    ...
    var Team = _classThis = /** @class */ (function (_super) {
        ...
        function Team_1() {
            ...
            _this.employees = (__runInitializers(_this, _type_extraInitializers), __runInitializers(_this, _employees_initializers, void 0));
    ...
    (function () {
        ...
        _employees_decorators = [(0, typeorm_1.OneToMany)(function () { return employee_1.Employee; }, function (employee) { return employee.team; })];
