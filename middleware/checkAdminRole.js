...
var employee_1 = require("../src/entities/employee");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, employee_1.Employee.findOne({
                        where: { email: email },
                        relations: ['role']
                    })];
            case 1:
                ...
                if (user.role.role != role_1.RoleTypes.Admin && user.role.role != role_1.RoleTypes.SuperAdmin) {
                    return [2 /*return*/, res.status(403).json({ message: "Access denied. Admins or Super Admins only." })];
                }
                next();
                return [2 /*return*/];
            case 2:
