...
var checkSuperAdminRole = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (user.role.role != role_1.RoleTypes.SuperAdmin) {
                    return [2 /*return*/, res.status(403).json({ message: "Access denied. Super Admins only." })];
                }
                next();
                return [2 /*return*/];
            case 2:
